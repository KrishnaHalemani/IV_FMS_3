...
if (isset($_SESSION['role'], $_SESSION['user_id'])) {
    $allowedRoles = getCreatableRoles((string) $_SESSION['role']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $formData['role'] = in_array($requestedRole, $allowedRoles, true) ? $requestedRole : 'user';
    ...
    if ($formData['username'] === '' || $formData['email'] === '' || $password === '' || $confirmPassword === '') {
        ...
        $checkStmt->bind_param("ss", $formData['email'], $formData['username']);
        $checkStmt->execute();
        ...
        <div class="auth-cover-sidebar-inner">
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <h4 class="fs-13 fw-bold mb-2">Manage all your IV crm</h4>
                    ...
                    <?php } ?>
                    <?php if ($success !== '') { ?>
                        <div class="alert alert-success mt-3"><?php echo htmlspecialchars($success, ENT_QUOTES, 'UTF-8'); ?></div>
                    <?php } ?>
                    <form method="POST" action="" class="w-100 mt-4 pt-2">
                        <div class="mb-4">
                            <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo htmlspecialchars($formData['username'], ENT_QUOTES, 'UTF-8'); ?>" required>
                        </div>
                        <div class="mb-4">
                            <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo htmlspecialchars($formData['email'], ENT_QUOTES, 'UTF-8'); ?>" required>
                        </div>
                        <div class="mb-4">
                            <select name="role" class="form-control" required>
                                <?php foreach ($allowedRoles as $roleOption) { ?>
                                    <option value="<?php echo htmlspecialchars($roleOption, ENT_QUOTES, 'UTF-8'); ?>" <?php echo $formData['role'] === $roleOption ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars(ucfirst($roleOption), ENT_QUOTES, 'UTF-8'); ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="mt-4">
                            <div class="custom-control custom-checkbox mb-2">
                                ...
                                <label class="custom-control-label c-pointer text-muted" for="receiveMial" style="font-weight: 400 !important">Yes, I wnat to receive IV community emails</label>
                            </div>
    ...
    <div class="theme-customizer">
        ...
        <div class="customizer-sidebar-wrapper">
            ...
            <div class="customizer-sidebar-footer px-4 ht-60 border-top d-flex align-items-center gap-2">
                ...
                <div class="flex-fill w-50">
                    <a href="https://www.themewagon.com/themes/IV-admin" target="_blank" class="btn btn-primary">Download</a>
                </div>
            </div>
        </div>
    </div>
