                                ...
                                <div class="d-lg-flex align-items-start">
                                    ...
                                    <div class="tab-content nxl-mega-menu-tabs-content">
                                        ...
                                        <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                            ...
                                            <h6 class="fw-bolder">IV - Admin Dashboard UiKit</h6>
                                            <p class="fs-12 fw-normal text-muted text-truncate-3-line">Get started IV with IV up and running. IV bootstrap template docs helps you to get started with simple html codes.</p>
                                        ...
                                        <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                            <div class="row g-4 align-items-center">
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <a href="mailto:theme_ocean@example.com" class="fs-13 fw-bold">View all resources on IV &rarr;</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="p-3 bg-soft-dark text-dark rounded d-lg-flex align-items-center justify-content-between">
                                                                        <div class="fs-13">
                                                                            ...
                                                                            <span>View all services on IV.</span>
                                                                        </div>
                                                                        <div class="mt-2 mt-lg-0">
                                                ...
                                                <div class="tab-pane fade" id="v-pills-features" role="tabpanel">
                                                    <div class="row g-4 nxl-mega-menu-miscellaneous-features">
                                                        ...
                                                        <div class="col-xxl-3 offset-xxl-1 col-xl-4">
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="mailto:theme_ocean@example.com" class="fs-13 fw-bold">View all features on IV &rarr;</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="list-unstyled activity-feed">
                                            ...
                                            <li class="d-flex justify-content-between feed-item feed-item-info">
                                                <div>
                                                    ...
                                                    <span class="text">Joined the group <a href="javascript:void(0);" class="fw-bold text-primary">"IV"</a></span>
                                                </div>
                                                <div class="ms-3 d-flex gap-2 align-items-center">
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
                                            ...
                                            <li class="d-flex justify-content-between feed-item feed-item-primary">
                                                <div>
                                                    ...
                                                    <span class="text">Attending the event <a href="javascript:void(0);" class="fw-bold text-primary">"IV Event"</a></span>
                                                </div>
                                                <div class="ms-3 d-flex gap-2 align-items-center">
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
                                            ...
                                            <li class="d-flex justify-content-between feed-item feed-item-danger">
                                                <div>
                                                    ...
                                                    <span class="text">IV meeting <a href="javascript:void(0);" class="badge bg-soft-warning text-warning ms-1">Join</a></span>
                                                </div>
                                                <div class="ms-3 d-flex gap-2 align-items-center">
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                                    <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
