                                                ...
                                                <td>
                                                    <div class="hstack gap-2">
                                                        ...
                                                        <div class="border-3 border-start rounded ps-3">
                                                            ...
                                                            <p class="fs-12 text-muted mb-0">Management of project under "IV" brand</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        ...
                                                        <div class="border-3 border-start rounded ps-3">
                                                            <a href="javascript:void(0);" class="mb-2 d-block">
                                                                <span>IV CRM Admin Project</span>
                                                            </a>
                                                            <p class="fs-12 text-muted mb-0">IV CRM Dashbaord Project</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        ...
                                                        <div class="border-3 border-start rounded ps-3">
                                                            <a href="javascript:void(0);" class="mb-2 d-block">
                                                                <span>IV CRM Dashbaord Project</span>
                                                            </a>
                                                            <p class="fs-12 text-muted mb-0">IV CRM Dashbaord Project</p>
                                                        </div>
                                                    </div>
