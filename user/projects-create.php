                            ...
                            <div class="card border-top-0">
                                <div class="card-body p-0" id="project-create-steps">
                                    ...
                                    <section class="step-body mt-4">
                                        <fieldset>
                                            <div class="mb-5">
                                                <h2 class="fs-16 fw-bold">Project Assigined</h2>
                                        ...
                                        <fieldset>
                                            ...
                                            <fieldset>
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="targetTitle" name="targetTitle" placeholder="Enter target title...">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="description" class="form-label">
                                                        Target Description <span class="text-danger">*</span>
                                                    </label>
        ...
        $(document).ready(function() {
            ...
            $('input[name="project_type"]').on('change', function() {
                ...
                if (type === 'personal') {
                    ...
                    $employeeSelect.prop('multiple', false);
                    $employeeSelect.val(null).trigger('change');

                } else if (type === 'team') {
                    // MULTIPLE employees allowed
                    $employeeSelect.prop('multiple', true);
                }
            });
