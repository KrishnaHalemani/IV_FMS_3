...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>IV || Projects Create</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
...
<body>
    ...
    <main class="nxl-container">
        <div class="nxl-content">
            ...
            <!-- [ page-header ] end -->
            <form id="projectCreateForm" method="POST" action="projects-store.php" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="card border-top-0">
                                <div class="card-body p-0" id="project-create-steps">
                                        ...
                                        <fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="alert alert-light border mt-3 mb-0">
                                                    Master can assign projects to superadmins, admins, and users.
                                                </div>
                                            </fieldset>
                                        </fieldset>
                                    ...
                                    <div class="step-title border-top">Team</div>
                                    <section class="step-body mt-4">
                                        <fieldset>
                                            <div class="mb-5">
                                                <h2 class="fs-16 fw-bold">Support team members</h2>
                                                <p class="text-muted">Choose internal employees who will support the project delivery.</p>
                                            </div>
                                            <fieldset>
                                                <div class="mb-4">
                                                    <label class="fw-semibold text-dark">Select employees</label>
                                                    ...
                                                    <small class="text-muted">
                                                        Personal project: 1 employee • Team project: multiple employees
                                                    </small>
                                                </div>
                                    ...
                                    <div class="step-title border-top">Milestones</div>
                                    <section class="step-body mt-4">
                                        <fieldset>
                                            <div class="mb-5">
                                                <h2 class="fs-16 fw-bold">Milestones</h2>
                                                <p class="text-muted">Set the major checkpoints you want the team to hit.</p>
                                            </div>
                                            <fieldset>
                                                    ...
                                                    <div class="border rounded p-3 mb-3">
                                                        <div class="row g-3">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" name="milestone_title[]" placeholder="Design approval">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="form-label">Due Date</label>
                                                                <input type="date" class="form-control" name="milestone_due_date[]">
                                                            </div>
                                                            <div class="col-md-5">
                                                                <label class="form-label">Description</label>
                                                                <input type="text" class="form-control" name="milestone_description[]" placeholder="Wireframes, homepage, dashboard approved">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <small class="text-muted">At least one milestone is recommended for tracking.</small>
                                                    <button type="button" class="btn btn-light-brand" id="addMilestoneBtn">
                                                        <i class="feather-plus me-2"></i>Add Milestone
                                                    </button>
                                                </div>
                                            </fieldset>
                                        </fieldset>
                                    ...
                                    <section class="step-body mt-4 text-center">
                                        ...
                                        <p class="text-muted mt-2">
                                            Click the button below to save the project.
                                        </p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#assignedUserId, #customerId, #relatedInvoiceId').select2({
                width: '100%'
            });

            $('#addMilestoneBtn').on('click', function() {
                $('#milestoneRows').append(`
                    <div class="border rounded p-3 mb-3">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label">Milestone Title</label>
                                <input type="text" class="form-control" name="milestone_title[]" placeholder="Testing sign-off">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Due Date</label>
                                <input type="date" class="form-control" name="milestone_due_date[]">
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Description</label>
                                <input type="text" class="form-control" name="milestone_description[]" placeholder="UAT and final fixes">
                            </div>
                            <div class="col-md-1 d-flex align-items-end">
                                <button type="button" class="btn btn-outline-danger w-100 remove-milestone">
            ...
            $('#milestoneRows').on('click', '.remove-milestone', function() {
                const $cards = $('#milestoneRows .border.rounded');

                if ($cards.length === 1) {
                    $cards.find('input').val('');
                    return;
                }
