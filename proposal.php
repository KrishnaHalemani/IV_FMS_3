            ...
            <div class="navbar-content">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="fs-11 my-3 text-dark">IV is a production ready CRM to get started up and running easily.</p>
                        <a href="https://www.themewagon.com/themes/IV-admin" target="_blank" class="btn btn-primary text-dark w-100">Download Now</a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <a href="proposal-view.php" class="avatar-text avatar-md">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="proposal-edit.php">
