                                    ...
                                    <?php if ($result && $result->num_rows > 0): ?>
                                        <?php while ($row = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="students-view.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm btn-light me-1"><i class="feather-eye"></i></a>
                                                    <a href="?delete_id=<?= (int) $row['id'] ?>" onclick="return confirm('Delete this student?')" class="btn btn-sm btn-danger"><i class="feather-trash-2"></i></a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    <?php endif; ?>
