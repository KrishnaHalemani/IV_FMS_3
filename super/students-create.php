                                ...
                                <div class="tab-pane fade show active">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-8"><input type="text" name="student_name" class="form-control" placeholder="Student Name" required></div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-4"><label>Email</label></div>
                                            <div class="col-lg-8"><input type="email" name="email" class="form-control" placeholder="Email"></div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-4"><label>Phone</label></div>
                                            <div class="col-lg-8"><input type="text" name="phone" class="form-control" placeholder="Phone"></div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-4"><label>Course</label></div>
                                            <div class="col-lg-8"><input type="text" name="course" class="form-control" placeholder="Course"></div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-4"><label>Address</label></div>
                                            <div class="col-lg-8"><textarea name="address" class="form-control" rows="3"></textarea></div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-lg-4"><label>About</label></div>
                                            <div class="col-lg-8"><textarea name="about" class="form-control" rows="4"></textarea></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-lg-8"><input type="date" name="dob" class="form-control"></div>
                                        </div>
                                        <div class="row mb-4">
