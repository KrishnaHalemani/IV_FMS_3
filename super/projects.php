...
<body>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="projectList">
                                        ...
                                        <tbody>
                                            ...
                                            $stmt->bind_param("ii", $currentLevel, $currentUserId);
                                            $stmt->execute();
                                                ...
                                                <tr class="single-item">
                                                    ...
                                                    <td class="project-name-td">
                                                        <div class="hstack gap-4">
                                                            ...
                                                            <div>
                                                                <a href="projects-view.php?id=<?= $row['id'] ?>" class="text-truncate-1-line"><?= htmlspecialchars($row['project_name']) ?></a>
                                                                <p class="fs-12 text-muted mt-2 text-truncate-1-line project-list-desc"><?= htmlspecialchars($row['description']) ?></p>
                                                    ...
                                                    <td>
                                                        <a href="projects-view.php" class="hstack gap-3">
                                                            <div class="avatar-image avatar-md">
                                                                <img src="assets/images/avatar/1.png" alt="" class="img-fluid">
                                                            </div>
                                                            <div>
                                                                <span class="text-truncate-1-line"><?= htmlspecialchars($row['customer_name']) ?></span>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <input type="date"
                                                            class="form-control form-control-sm project-date"
                                                            data-project="<?= $row['id'] ?>"
                                                    ...
                                                    <td>
                                                        <select class="form-control project-status"
                                                            ...
                                                            foreach ($statuses as $status) {
                                                                $selected = ($row['project_status'] === $status) ? 'selected' : '';
                                                    ...
                                                    <td class="text-end">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <!-- VIEW -->
                                                            <a href="projects-view.php?id=<?= $row['id'] ?>"
                                                                class="avatar-text avatar-md">
                                                                <i class="feather feather-eye"></i>
                                                            </a>

                                                            <!-- DELETE -->
                                                            <form action="projects-delete.php" method="POST" 
    ...
    <script>
        document.querySelectorAll('.assigned-user').forEach(select => {
            select.addEventListener('change', function() {
                fetch('update-project-user.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                    },
                    body: `project_id=${this.dataset.project}&user_id=${this.value}`
                });
            });
        });
        ...
        document.querySelectorAll('.project-status').forEach(select => {
            select.addEventListener('change', function() {
                fetch('update-project-status.php', {
                    ...
                    body: `project_id=${this.dataset.project}&status=${this.value}`
                });
            });
        });
    </script>
    ...
    <script>
        document.querySelectorAll('.project-date').forEach(input => {
            input.addEventListener('change', function() {
                fetch('update-project-date.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                    },
                    body: `project_id=${this.dataset.project}&field=${this.dataset.field}&value=${this.value}`
                });
            });
        });
    </script>
        ...
        document.querySelectorAll('.project-status').forEach(select => {
            select.addEventListener('change', function() {
                ...
                fetch('update-project-status.php', {
                        ...
                        body: `project_id=${projectId}&status=${encodeURIComponent(status)}`
                    })
                    .then(res => {
