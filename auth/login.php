...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Infinite Vision || Login Cover</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
            ...
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <form method = "POST" action=""  class="w-100 mt-4 pt-2">
                        <div class="mb-4">
                            <input type="email" name="email" class="form-control" placeholder="Email" value="test@gmail.com" required>
                        </div>
                        <div class="mb-3">
...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        // 🔥 AFTER LOGIN → GO TO dashboard.php
        header("Location: dashboard.php");
        exit;
